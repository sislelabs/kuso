...
const messages = {
  ...
  notifications: {
    ...
    helpText: '<p><strong>Benachrichtigungen</strong> ermöglichen es Dir, über Ereignisse in Ihren Kuso-Anwendungen informiert zu werden. Du kannst Slack-, Discord- oder Webhook-Benachrichtigungen konfigurieren, um über Deployments, Fehler und andere wichtige Ereignisse auf dem Laufenden zu bleiben.</p><p class="mt-2"><a href="https://www.kuso.sislelabs.com/docs/usermanual/notifications/" target="_blank" rel="noopener">Mehr in der Kuso-Dokumentation lesen</a></p>',
    form: {
      name: 'Name',
      type: 'Typ',
      enabled: 'Aktiviert',
  ...
  runpacks: {
    ...
    helpText: '<p><strong>Runpacks</strong> in Kuso definieren, wie Ihre Anwendung im Kubernetes-Cluster abgerufen, gebaut und ausgeführt wird. Jedes Runpack besteht aus drei Phasen:</p><ul class="ma-4"><li><strong>Fetch</strong>: Ruft Ihren Code aus einem Git-Repository mit einem Container-Image ab. Sie können das Standard verwenden oder es anpassen.</li><li><strong>Build</strong>: Führt Build-Befehle in einem Container Ihrer Wahl aus (beliebiges Docker-Image). Hier werden Abhängigkeiten installiert oder Ihre App kompiliert.</li><li><strong>Run</strong>: Startet den finalen Container. Der <em>web</em>-Pod wird ins Internet freigegeben, während <em>worker</em>-Pods für Hintergrundaufgaben sind.</li></ul><p>Runpacks sind sehr flexibel und können für verschiedene Sprachen und Frameworks angepasst werden. Sie basieren auf öffentlich verfügbaren Container-Images. Beispiel-Runpacks finden Sie unter <a href="https://github.com/sislelabs/runpacks/tree/main/packs" target="_blank" rel="noopener">sislelabs/runpacks</a>.</p><p class="mt-2"><a href="https://www.kuso.sislelabs.com/docs/usermanual/runpacks/" target="_blank" rel="noopener">Mehr in der Kuso-Dokumentation lesen</a></p>',
    table: {
      name: 'Name',
      language: 'Sprache',
      fetch: 'Fetch',
  ...
  settings: {
    deployment: {
      ...
      configAlert: 'Konfigurationsänderungen werden erst wirksam, wenn der Kuso UI Container manuell neu gestartet wird.',
    ...
    general: {
      title: 'Allgemeine Kuso-Einstellungen',
  ...
  podsizes: {
    ...
    helpText: '<p><strong>Pod-Größen</strong> definieren die Ressourcenanforderungen und -limits für die Pods Ihrer Anwendung in Kuso. Sie können Pod-Größen erstellen, bearbeiten und löschen, um sie an Ihre Workload-Anforderungen anzupassen.</p><p class="mt-2"><a href="https://www.kuso.sislelabs.com/docs/usermanual/podsizes/" target="_blank" rel="noopener">Mehr in der Kuso-Dokumentation</a></p>',
    form: {
      name: 'Pod-Größenname',
      description: 'Beschreibung',
