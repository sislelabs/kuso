...
func apiv1CreateServiceToDomain(in apiv1.CreateServiceRequest) projects.CreateServiceRequest {
	...
	if in.Repo != nil {
		out.Repo = &projects.CreateServiceRepo{URL: in.Repo.URL, Path: in.Repo.Path, Provider: in.Repo.Provider, DefaultBranch: in.Repo.DefaultBranch, Token: in.Repo.Token}
	}
	if len(in.Domains) > 0 {
