...
Older releases (v0.9.27 and earlier) are archived in
[CHANGELOG.archive.md](./CHANGELOG.archive.md) so this file stays a
sensible size for browsing on GitHub and shipping in the npm tarball.
