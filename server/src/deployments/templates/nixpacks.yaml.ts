...
# Source: kusobuild/templates/job-nixpack.yaml
apiVersion: batch/v1
kind: Job
metadata:
  generation: 1
    ...
    spec:
      ...
      initContainers:
        ...
        - name: build
          ...
          - -c
          - nixpacks build . -o .
          image: "ghcr.io/sislelabs/kuso-build:latest"
          imagePullPolicy: Always
          resources: {}
          securityContext:
            privileged: false
        ...
        - name: push
          ...
          - name: BUILD_IMAGE
            value: registry-kuso.yourdomain.com/optionalrepositoryowner/pipeline/app:123456
