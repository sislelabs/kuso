...
export class KusoAddonMysql extends Plugin implements IPlugin {
  ...
  public formfields: { [key: string]: IPluginFormFields } = {
    ...
    'KusoAddonMysql.spec.mysql.image.tag': {
      type: 'combobox',
      label: 'Version/Tag',
    ...
    'KusoAddonMysql.spec.mysql.settings.rootPassword.value': {
      type: 'text',
    ...
    'KusoAddonMysql.spec.mysql.userDatabase.user.value': {
      type: 'text',
      label: 'Username*',
    ...
    'KusoAddonMysql.spec.mysql.userDatabase.password.value': {
      type: 'text',
      label: 'User Password*',
    ...
    'KusoAddonMysql.spec.mysql.userDatabase.name.value': {
      type: 'text',
      label: 'Database*',
    ...
    'KusoAddonMysql.spec.mysql.storage.className': {
    ...
    'KusoAddonMysql.spec.mysql.storage.requestedSize': {
      type: 'text',
      label: 'Storage Size*',
