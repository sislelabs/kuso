...
export class KusoRabbitMQ extends Plugin implements IPlugin {
  ...
  public formfields: { [key: string]: IPluginFormFields } = {
    ...
    'KusoRabbitMQ.spec.rabbitmq.image.tag': {
      type: 'combobox',
      label: 'Version/Tag',
    ...
    'KusoRabbitMQ.spec.rabbitmq.auth.username': {
      type: 'text',
      label: 'User Name*',
    ...
    'KusoRabbitMQ.spec.rabbitmq.global.auth.password': {
      type: 'text',
      label: 'User Password',
    ...
    'KusoRabbitMQ.spec.rabbitmq.global.rabbitmq.auth.securepassword': {
      type: 'text',
    ...
    'KusoRabbitMQ.spec.rabbitmq.global.rabbitmq.auth.erlangCookie': {
      type: 'text',
      label: 'Erlang Cookie',
    ...
    'KusoRabbitMQ.spec.rabbitmq.global.storageClass': {
    ...
    'KusoRabbitMQ.spec.rabbitmq.maxAvailableSchedulers': {
      type: 'number',
    ...
    'KusoRabbitMQ.spec.rabbitmq.onlineSchedulers': {
      type: 'number',
