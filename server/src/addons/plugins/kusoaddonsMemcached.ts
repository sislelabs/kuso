...
export class KusoAddonMemcached extends Plugin implements IPlugin {
  ...
  public formfields: { [key: string]: IPluginFormFields } = {
    'KusoAddonMemcached.metadata.name': {
      type: 'text',
    ...
    'KusoAddonMemcached.spec.memcached.image.tag': {
      type: 'combobox',
      label: 'Version/Tag',
    ...
    'KusoAddonMemcached.spec.memcached.replicaCount': {
      type: 'number',
      label: 'Replica Count',
    ...
    'KusoAddonMemcached.spec.memcached.config.memoryLimit': {
      type: 'number',
    ...
    'KusoAddonMemcached.spec.memcached.config.maxConnections': {
      type: 'number',
  ...
  public resourceDefinitions: object = {
    KusoAddonMemcached: {
      ...
      kind: "KusoAddonMemcached",
      metadata: {
        name: "kusoaddonmemcached-sample"
      },
      spec: {
        memcached: {
          image: {
