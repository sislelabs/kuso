...
export class KusoMemcached extends Plugin implements IPlugin {
  ...
  public formfields: { [key: string]: IPluginFormFields } = {
    ...
    'KusoMemcached.spec.memcached.image.tag': {
      type: 'combobox',
      label: 'Version/Tag',
    ...
    'KusoMemcached.spec.memcached.architecture': {
      type: 'select',
      label: 'Architecture*',
    ...
    'KusoMemcached.spec.memcached.global.storageClass': {
    ...
    'KusoMemcached.spec.memcached.auth.enabled': {
      type: 'switch',
    ...
    'KusoMemcached.spec.memcached.auth.username': {
      type: 'text',
      label: 'Username',
      name: 'spec.memcached.auth.username',
      default: '',
    ...
    'KusoMemcached.spec.memcached.auth.password': {
      type: 'text',
      label: 'Password',
    ...
    'KusoMemcached.spec.memcached.resources.requests.memory': {
      type: 'text',
      label: 'Memory',
    ...
    'KusoMemcached.spec.memcached.replicaCount': {
      type: 'number',
      label: 'Replica Count',
    ...
    'KusoMemcached.spec.memcached.autoscaling.enabled': {
      type: 'switch',
    ...
    'KusoMemcached.spec.memcached.autoscaling.minReplicas': {
      type: 'number',
    ...
    'KusoMemcached.spec.memcached.autoscaling.maxReplicas': {
      type: 'number',
