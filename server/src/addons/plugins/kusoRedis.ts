...
export class KusoRedis extends Plugin implements IPlugin {
  ...
  public formfields: { [key: string]: IPluginFormFields } = {
    ...
    'KusoRedis.spec.redis.image.tag': {
      type: 'combobox',
      label: 'Version/Tag',
    ...
    'KusoRedis.spec.redis.replica.replicaCount': {
      type: 'number',
      label: 'Replica Count*',
    ...
    'KusoRedis.spec.redis.global.storageClass': {
    ...
    'KusoRedis.spec.redis.master.persistence.size': {
      type: 'text',
    ...
    'KusoRedis.spec.redis.replica.persistence.size': {
      type: 'text',
    ...
    'KusoRedis.spec.redis.global.redis.password': {
      type: 'text',
      label: 'Password*',
