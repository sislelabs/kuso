...
export class KusoPostgresql extends Plugin implements IPlugin {
  ...
  public formfields: { [key: string]: IPluginFormFields } = {
    ...
    'KusoPostgresql.spec.postgresql.image.tag': {
      type: 'combobox',
      label: 'Version/Tag',
    ...
    'KusoPostgresql.spec.postgresql.global.postgresql.auth.postgresPassword':
      {
        type: 'text',
    ...
    'KusoPostgresql.spec.postgresql.global.postgresql.auth.username': {
      type: 'text',
      label: 'Username*',
    ...
    'KusoPostgresql.spec.postgresql.global.postgresql.auth.password': {
      type: 'text',
      label: 'User Password*',
    ...
    'KusoPostgresql.spec.postgresql.global.postgresql.auth.database': {
      type: 'text',
      label: 'Database*',
    ...
    'KusoPostgresql.spec.postgresql.global.storageClass': {
    ...
    'KusoPostgresql.spec.postgresql.primary.persistence.size': {
      type: 'text',
      label: 'Sorage Size*',
