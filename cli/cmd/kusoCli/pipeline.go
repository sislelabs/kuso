...
func getPipelinePhasesFromCRD(pipelineCRD kusoApi.PipelineCRD) []string {
	var phases []string
...
func loadPipelineConfig(pipelineName string, local bool) kusoApi.PipelineCRD {
...
func loadRemotePipelineConfig(pipelineName string) *viper.Viper {
	...
	var pipeline kusoApi.PipelineSpec
