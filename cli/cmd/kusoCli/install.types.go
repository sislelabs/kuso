...
type KusoUIConfig struct {
	...
	Spec struct {
		...
		Kuso      struct {
			...
			Config KusoConfigfile `yaml:"config,omitempty" gorm:"embedded"`
		} `yaml:"kuso" gorm:"embedded"`
