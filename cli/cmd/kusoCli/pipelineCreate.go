...
func createPipeline() kusoApi.PipelineCRD {
...
func writePipelineYaml(pipeline kusoApi.PipelineCRD) {
	basePath := "/.kuso/" //TODO Make it dynamic
...
func pipelinesForm() kusoApi.PipelineCRD {

	var pipelineCRD kusoApi.PipelineCRD
	...
	pipelineCRD.APIVersion = "application.kuso.sislelabs.com/v1alpha1"
	pipelineCRD.Kind = "KusoPipeline"
	...
	if gitconnection == "y" {
		...
		if phaseReview == "y" {
			...
			pipelineCRD.Spec.Phases = append(pipelineCRD.Spec.Phases, kusoApi.Phase{
				Name:    "review",
				Enabled: true,
