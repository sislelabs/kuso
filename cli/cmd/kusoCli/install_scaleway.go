...
func installScaleway() {
	...
	// _, _ = cfmt.Println("{{⚠ Installing Kubernetes on Scaleway is currently beta state in kuso-cli}}::yellow")
	...
	*/
	...
	cluster.Name = promptLine("Kubernetes Cluster Name", "", "kuso-"+strconv.Itoa(rand.Intn(1000)))
