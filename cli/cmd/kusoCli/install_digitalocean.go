...
func installDigitalOcean() {
	...
	_, _ = cfmt.Println("{{⚠ Installing Kubernetes on Digital Ocean is currently beta state in kuso-cli}}::yellow")
	...
	doConfig.Name = promptLine("Kubernetes Cluster Name", "", "kuso-"+strconv.Itoa(rand.Intn(1000)))
