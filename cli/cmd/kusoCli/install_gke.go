...
func installGKE() {
	...
	// gcloud container clusters create kuso-cluster-4 --region=us-central1-c
	// gcloud container clusters get-credentials kuso-cluster-4 --region=us-central1-c

	// https://cloud.google.com/kubernetes-engine/docs/reference/libraries#client-libraries-install-go
	// https://github.com/googleapis/google-cloud-go

	gcloudName := promptLine("Kubernetes Cluster Name", "", "kuso-"+strconv.Itoa(rand.Intn(1000)))
